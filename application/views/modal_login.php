...
<head>
  ...
  min-height: 450px; /* Mantén la misma altura para ambos formularios */
    ...
    .contenedor__login-register form {
      ...
      border-radius: 2px;
      height: 550px;
  overflow: visible; /* Asegura que no se recorten partes de las letras */
    }
    ...
    .contenedor__login-register form input {
      ...
      font-family: "Maname";
      outline: none;
      line-height: 1.6; /* Asegura que las letras tengan espacio vertical */
      margin-top: 30px; /* Aumenta este valor para mayor separación */
      margin-bottom: 5px; /* Opcional, si necesitas espacio abajo */
      /* Ajusta este valor para mover el texto más arriba */
  padding-bottom: 10px; /* Ajusta el relleno inferior si es necesario */
  overflow: visible; /* Asegura que no se recorten partes de las letras */
height: auto; /* O una altura que se adapte al contenido */

}
.formulario__register {
  display: none;  /* Lo mantengo oculto inicialmente */
  min-height: 450px;   /* Ajusta la altura mínima */
  overflow: hidden;   /* Evita el desbordamiento */
  max-width: 400px;  /* Define un ancho máximo adecuado */
}
...
min-height: 450px; 
    ...
    .img{
      ...
      margin-left: -18px; /* Ajusta el valor según necesites */
    }
    .sesion{
      font-family: "Merriweather";
...
.forgot-password {
  display: block; /* Para que quede en una línea separada */
  text-align: left; /* Alineación a la derecha (opcional) */
  margin-top: 15px; /* Espaciado entre el enlace y el campo */
  font-size: 20px; /* Tamaño de fuente más pequeño */
  color: #6F56FF; /* Color del enlace */
  transition: color 0.3s;
}

.forgot-password:hover {
  color: #FFD700;  /* Color cuando se pasa el mouse */
}
...
.legal-links {
  ...
  gap: 25px; /* Espaciado más amplio entre los enlaces y el separador */
  margin-top: 10px; /* Espaciado respecto al contenido superior */
...
.password-icon {
  ...
  cursor: pointer;
  color: gray;
  font-size: 18px;  /* Estilo específico para el ícono de contraseña */
}
...
.confirm-password-icon {
  ...
  cursor: pointer;
  color: gray;
  font-size: 18px;  /* Estilo específico para el ícono de confirmar contraseña */
  transition: color 0.3s ease; /* Agregar animación de color al pasar el cursor */
}
...
input[type="password"] {
  ...
  margin-top: 10px;
  margin-bottom: 5px;
  padding-bottom: 15px; /* Aumenta este valor para dar más espacio a las letras descendentes */
  height: auto; /* Esto permite que la altura se ajuste según el contenido */
}
...
/*modal */
  ...
  .back {
    position: absolute;  /* Asegura que esté posicionado respecto al contenedor */
    bottom: 20px;
    right: 20px;
    color: white;
    font-size: 0.9em;
...
<div class="password-container" style="position: relative;">
  ...
  <i id="toggleRegisterConfirmPassword" class="fas fa-eye confirm-password-icon"></i>
        ...
        <input type="text" placeholder="Puesto" class="estedee">
